<nav class="navbar fixed-top navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="./src/logo.png" alt="logo" width="120">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto w-100 justify-content-end">
                    <li class="nav-item active" id='home-nav'>
                        <a class="nav-link paragraph" href="#">Home</a>
                    </li>
                    <li class="nav-item" id='about-nav'>
                        <a class="nav-link paragraph" href="#about">About</a>
                    </li>
                    ...
                    <li class="nav-item" id='update-nav'>
                        <a class="nav-link paragraph" href="#update">Update</a>
                    </li>
